...
<?php
	...
	$conn = mysqli_connect("localhost", "wechujfx_probizlist_user", "hZ2Fxm#1]a{r", "wechujfx_probizlist");
	$sql_ad_load = "SELECT * FROM adverts ORDER BY id_ad DESC LIMIT ".$_POST["start"].", ".$_POST["limit"]."";
...
<?php
	...
	$ad_img = $item_imgs[0];
?>
<a href="adpage.php?aid=<?php echo $row_ad_load["id_ad"];?>"><div class="ad-item"><img src="images/ads/<?php echo $ad_img;?>" alt="">
